...
def loadModel():
    model_close = load_model("./model/GRU/bitcoin_GRU_8_2_close.h5")
    model_open = load_model("./model/GRU/bitcoin_GRU_8_2_open.h5")
    model_high = load_model("./model/GRU/bitcoin_GRU_8_2_high.h5")
    model_low = load_model("./model/GRU/bitcoin_GRU_8_2_low.h5")
...
def prepareVariable(df,MA_1,MA_2,MA_3):
    ...
    df.to_csv("./data/GRU/btc_pred_process.csv", index=False)
...
if __name__ == '__main__':
    ...
    n=5
    df3 = pd.read_csv("./data/GRU/btc_pred_process.csv")
    for i in range(n):
            pred = []
    ...
    df3.to_csv('./predict/GRU/final_pred_GRU.csv')
